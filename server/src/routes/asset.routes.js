...
const { requireAuth, requireModuleAccess, requireRole, hasPermission, requireAnyWriteAccess } = require("../middleware/auth");
...
router.get("/:assetId/audit-logs", requireAnyWriteAccess("ASSET"), asyncHandler(getAssetAuditLogs));
router.post(
  "/:assetId/action",
